...
RUN apk --no-progress update && \
    ...
    curl --output /tmp/syncthing-v${SYNCTHING_VERSION}.tar.gz --silent --location https://github.com/syncthing/syncthing/releases/download/v$SYNCTHING_VERSION/syncthing-linux-amd64-v${SYNCTHING_VERSION}.tar.gz && \
